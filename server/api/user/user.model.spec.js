...
var user = new User({
  ...
  password: 'password'
  //acl: [
  //  {_company: '5665de97e664a6501af6f8f7', roles:['none', 'purchase']},
  //  {_company: '5665de97e664a6501af6f8f8', roles:['admin', 'none']}
  //]
});
...
//  info: faker.company.companyName() + ' ' + faker.company.companySuffix(),
//  active: true
//});
